...
#Please utilize this Powershell script as a last restort & only if Reset Microsoft Authenticator for O365 available on Software Center doesn't work.
...
#$Folder = '%localappdata%\Packages\Microsoft.AAD.BrokerPlugin_cw5n1h2txyewy'
