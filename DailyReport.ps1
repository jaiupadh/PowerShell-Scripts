...
Send-MailMessage -From 'Jaidev Upadhya <jaidev.upadhya@entrust.com>' -To 'MailHarmanIT <MailHarmanIT@entrust.com>' -Subject 'Daily Productivity Report' -Body "Please find the Excel file enclosed within this email" -Attachments "$Folder\DataCaptured.xlsx" -Priority High -DeliveryNotificationOption OnSuccess, OnFailure -SmtpServer 'outlook.entrust.com' -Port '25'
